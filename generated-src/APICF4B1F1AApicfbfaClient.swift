...
public class APICF4B1F1AApicfbfaClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "APICF4B1F1AApicfbfaClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:APICF4B1F1AApicfbfaClient = {
        ...
        return APICF4B1F1AApicfbfaClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = APICF4B1F1AApicfbfaClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `APICF4B1F1AApicfbfaClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> APICF4B1F1AApicfbfaClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         APICF4B1F1AApicfbfaClient.registerClient(withConfiguration: configuration, forKey: "USWest2APICF4B1F1AApicfbfaClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = APICF4B1F1AApicfbfaClient.client(forKey: "USWest2APICF4B1F1AApicfbfaClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(APICF4B1F1AApicfbfaClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> APICF4B1F1AApicfbfaClient {
		objc_sync_enter(self)
		if let client: APICF4B1F1AApicfbfaClient = _serviceClients.object(forKey: key) as? APICF4B1F1AApicfbfaClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			APICF4B1F1AApicfbfaClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! APICF4B1F1AApicfbfaClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://rjwip99my7.execute-api.us-east-1.amazonaws.com/dev"
